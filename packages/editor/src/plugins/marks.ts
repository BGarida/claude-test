...
// Inlined from share-content-filter — just a constant string key
const SHARE_CONTENT_FILTER_ALLOW_META = 'proof.share.allowContentMutation';

// MarkdownParser type used throughout this module
type MarkdownParser = (text: string) => ProseMirrorNode;
