...
function createAgentFaceElement(_opts: any): HTMLElement {
  const span = document.createElement('span');
  return span;
}
function isAgentIdentity(_identity: any): boolean {
  return false;
}
function resolveAgentFamily(_identity: any): AgentFamily {
  return 'purple';
}
