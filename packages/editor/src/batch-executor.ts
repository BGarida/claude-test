...
// TODO: Analytics integration — captureEvent stubbed out
function captureEvent(_event: string, _data: Record<string, unknown>): void {
  // Stub: analytics/telemetry not yet extracted
}
